...
class UUID{
	...
	public static function fromRandom() : UUID{
		return self::fromData((\pack("N", time())), (\pack("n", ($pid = getmypid()) !== false ? $pid : 0)), (\pack("n", ($uid = getmyuid()) !== false ? $uid : 0)), (\pack("N", mt_rand(-0x7fffffff, 0x7fffffff))), (\pack("N", mt_rand(-0x7fffffff, 0x7fffffff))));
	}
